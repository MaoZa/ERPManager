...
<body onLoad="clockon(bgclock)" class="bgnoprint" bgcolor="#AE8F00">
<table width="757" height="174" border="0" align="center"cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table width="100%" height="26" border="0" cellpadding="0" cellspacing="0" background="images/area_bg.jpg" style="background-size:100% 100%;" class="noprint">
        <tr>
