...
function mycheck(form){
	...
	if(form.borrowperson.value==""){
		alert("请填写借用人!");form.borrowperson.focus();return false;
	}	
	if(form.btel.value==""){
		alert("请填写借用人联系电话!");form.btel.focus();return false;
	}	
	if(form.bunit.value==""){
		alert("请填写借用人工作单位!");form.bunit.focus();return false;
	}	
...
元 </td>
                ...
                <tr>
                  <td align="left"style="padding-left:10px">借出数量：              </td>
                  <td align="left"style="padding-left:10px"><input name="number" type="text" id="number" value="1" size="8" onBlur="subcheck(form1)">
                    <%=selUnit%></td>
                </tr>
                <tr>
                  <td align="left"style="padding-left:10px">借 用 人：</td>
                  <td align="left"style="padding-left:10px"><input name="borrowperson" type="text" id="borrowperson" size="20"></td>
                </tr>
                <tr>
                  <td align="left"style="padding-left:10px">联系电话：</td>
                  <td align="left"style="padding-left:10px"><input name="btel" type="text" id="btel" size="20"></td>
                </tr>
                <tr>
                  <td align="left"style="padding-left:10px">工作单位：</td>
                  <td align="left"style="padding-left:10px"><input name="bunit" type="text" id="bunit" size="20"></td>
                </tr>								
                <tr>
