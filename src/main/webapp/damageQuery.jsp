		...
		<tr>
			<td><table width="100%" height="26" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="4%">&nbsp;</td>
						<td width="70%" valign="bottom">当前位置：查询统计 &gt; 部门报损查询
							&gt;&gt;&gt;</td>
					</tr>
				</table>
					...
					<tr>
						...
						<td align="center" valign="top">&nbsp;
							<table width="96%" height="487" border="0" cellpadding="0"
								...
								<tr>
									<td align="center" valign="top">
										<form name="myform" method="post" action="ifDeal/damageQuery">
											<table width="98%" border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td height="14"><div>
															<input name="flag" type="checkbox" class="noborder"
																value="a" checked> 请选择查询依据： <select name="f"
												...
												<tr>
													<td><input name="flag" type="checkbox"
														class="noborder" id="flag" value="b"> 报损时间： 从 <input
 ...
 %>
										<table width="98%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr>
												...
												<td style="padding: 5px;">&nbsp;<%=damagenum%>(<%=unit%>)
												</td>
