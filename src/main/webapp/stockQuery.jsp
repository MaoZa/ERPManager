...
<body onLoad="clockon(bgclock)" bgcolor="#AE8F00">
		...
		<tr>
			<td><table width="100%" height="26" border="0" cellpadding="0"
					...
					<tr>
						...
						<td width="4%">&nbsp;</td>
						<td width="70%" valign="bottom">当前位置：查询统计 &gt; 采购单查询
							&gt;&gt;&gt;</td>
					</tr>
				</table>
					...
					<tr>
						...
						<td align="center" valign="top">&nbsp;
							<table width="96%" height="487" border="0" cellpadding="0"
								...
								<tr>
									<td align="center" valign="top">
										<form name="myform" method="post" action="/ifDeal/stockQuery">
											<table width="98%" border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													<td height="15"><input name="flag" type="checkbox"
														class="noborder" id="flag" value="b"> 采购时间： 从 <input
												...
												<tr>
													<td height="15"><input name="flag" type="checkbox"
														class="noborder" id="flag" value="c"> <input
														name="state" type="radio" class="noborder" value="0"
														checked> 未审核&nbsp; <input name="state"
														type="radio" class="noborder" value="1"> 已入库&nbsp;
										...
										<table width="98%" border="1" cellpadding="0" cellspacing="0"
											...
											<tr>
												<td style="padding: 5px;">&nbsp;<a
													href="ifDeal/stockDetail&id=<%=id%>"><%=sno%></a></td>
