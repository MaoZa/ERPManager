...
<table width="96%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="top">
		<form name="myform" method="post" action="ifDeal/loanBackQuery">
...
(日期格式为：2006-07-05)<input name="state" type="hidden" id="state" value="1">
</td>
            </tr>
          </table>
		</form>
...
%>
  <tr>
    ...
    <td align="center" style="padding:5px;"><a href="loan/backloan&id=<%=id%>"><img src="images/enforce.gif" width="16" height="16" border="0"></a></td>
 </tr>
 <%} %>
</table>
<%}%>
